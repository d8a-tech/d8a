...
func sessionColumns() []schema.SessionColumn {
	return []schema.SessionColumn{
		...
		sessioncolumns.SessionGeoCityColumn,
		sessioncolumns.SessionGeoRegionColumn,
		sessioncolumns.SessionGeoMetroColumn,
		sessioncolumns.SessionGeoCountryColumn,
		sessioncolumns.SessionGeoContinentColumn,
		sessioncolumns.SessionGeoSubContinentColumn,
		sessioncolumns.SessionDeviceCategoryColumn,
		sessioncolumns.SessionDeviceLanguageColumn,
		sessioncolumns.SessionDeviceMobileBrandNameColumn,
		sessioncolumns.SessionDeviceMobileModelNameColumn,
		sessioncolumns.SessionDeviceOperatingSystemColumn,
		sessioncolumns.SessionDeviceOperatingSystemVersionColumn,
		sessioncolumns.SessionDeviceWebBrowserColumn,
		sessioncolumns.SessionDeviceWebBrowserVersionColumn,
		sessioncolumns.SessionDeviceScreenResolutionColumn,
