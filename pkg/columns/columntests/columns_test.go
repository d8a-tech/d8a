...
func TestEventColumns(t *testing.T) {
	...
	var eventColumnTestCases = []struct {
		...
		{
			name:        "EventUtmSourceMedium_Valid",
			param:       "dl",
			value:       "https://example.com/page?foo=bar&utm_source=1337&utm_medium=1338",
			expected:    "1337/1338",
			fieldName:   "utm_source_medium",
			description: "Valid UTM source medium",
		},
		{
			name:        "EventUtmSourceMedium_Empty",
			param:       "dl",
			value:       "https://example.com/page?foo=bar",
			expected:    nil,
			fieldName:   "utm_source_medium",
			description: "Empty UTM source medium",
		},
		{
			name:        "EventUtmSourceMedium_MissingSource",
			param:       "dl",
			value:       "https://example.com/page?foo=bar&utm_medium=1338",
			expected:    nil,
			fieldName:   "utm_source_medium",
			description: "Missing UTM source",
		},
		{
			name:        "EventUtmSourceMedium_MissingMedium",
			param:       "dl",
			value:       "https://example.com/page?foo=bar&utm_source=1337",
			expected:    nil,
			fieldName:   "utm_source_medium",
			description: "Missing UTM medium",
		},
		{
