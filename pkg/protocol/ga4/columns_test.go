...
func TestEventColumns(t *testing.T) {
	...
	var eventColumnTestCases = []struct {
		...
		},
		{
			...
			param:       "dl",
			value:       "https://example.com/page?foo=bar&baz=qux",
...
func TestSessionColumns(t *testing.T) {
	...
	var sessionColumnTestCases = []struct {
		...
		},
		{
			...
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "screen_view"),
				columntests.EnsureQueryParam(0, "seg", ""),
				columntests.EnsureEventName(1, "screen_view"),
				columntests.EnsureQueryParam(1, "seg", ""),
			},
		},
		{
		...
		},
		{
			...
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "purchase"),
				columntests.EnsureQueryParam(0, "sct", "2"),
			},
		},
		{
		...
		{
			name:        "SessionUtmMarketingTactic_FirstEvent",
			expected:    "1337", // should be the first page view's UTM marketing tactic
			fieldName:   "session_utm_marketing_tactic",
		...
		{
			name:        "SessionUtmMarketingTactic_SecondEvent",
			expected:    "1338",
			fieldName:   "session_utm_marketing_tactic",
		...
		{
			name:        "SessionUtmMarketingTactic_NoPageViews",
			expected:    nil,
			fieldName:   "session_utm_marketing_tactic",
		...
		{
			name:        "SessionUtmSourcePlatform_FirstEvent",
			expected:    "1337",
			fieldName:   "session_utm_source_platform",
		...
		{
			name:        "SessionUtmSourcePlatform_SecondEvent",
			expected:    "1338",
			fieldName:   "session_utm_source_platform",
		...
		{
			name:        "SessionUtmSourcePlatform_NoPageViews",
			expected:    nil,
			fieldName:   "session_utm_source_platform",
		...
		{
			name:        "SessionUtmTerm_FirstEvent",
			expected:    "1337",
			fieldName:   "session_utm_term",
		...
		{
			name:        "SessionUtmTerm_SecondEvent",
			expected:    "1338",
			fieldName:   "session_utm_term",
		...
		{
			name:        "SessionUtmTerm_NoPageViews",
			expected:    nil,
			fieldName:   "session_utm_term",
		...
		{
			name:        "SessionUtmContent_FirstEvent",
			expected:    "1337",
			fieldName:   "session_utm_content",
		...
		{
			name:        "SessionUtmContent_SecondEvent",
			expected:    "1338",
			fieldName:   "session_utm_content",
		...
		{
			name:        "SessionUtmContent_NoPageViews",
			expected:    nil,
			fieldName:   "session_utm_content",
		...
		{
			name:        "SessionUtmSource_FirstEvent",
			expected:    "1337",
			fieldName:   "session_utm_source",
		...
		{
			name:        "SessionUtmSource_SecondEvent",
			expected:    "1338",
			fieldName:   "session_utm_source",
		...
		{
			name:        "SessionUtmSource_NoPageViews",
			expected:    nil,
			fieldName:   "session_utm_source",
		...
		{
			name:        "SessionUtmMedium_FirstEvent",
			expected:    "1337",
			fieldName:   "session_utm_medium",
		...
		{
			name:        "SessionUtmMedium_SecondEvent",
			expected:    "1338",
			fieldName:   "session_utm_medium",
		...
		{
			name:        "SessionUtmMedium_NoPageViews",
			expected:    nil,
			fieldName:   "session_utm_medium",
		...
		{
			name:        "SessionUtmCampaign_FirstEvent",
			expected:    "1337",
			fieldName:   "session_utm_campaign",
		...
		{
			name:        "SessionUtmCampaign_SecondEvent",
			expected:    "1338",
			fieldName:   "session_utm_campaign",
		...
		{
			name:        "SessionUtmCampaign_NoPageViews",
			expected:    nil,
			fieldName:   "session_utm_campaign",
		...
		{
			name:        "SessionUtmID_FirstEvent",
			expected:    "1337",
			fieldName:   "session_utm_id",
		...
		{
			name:        "SessionUtmCreativeFormat_FirstEvent",
			expected:    "1337",
			fieldName:   "session_utm_creative_format",
		...
		{
			name:        "SessionUtmCreativeFormat_SecondEvent",
			expected:    "1338",
			fieldName:   "session_utm_creative_format",
		...
		{
			name:        "SessionUtmCreativeFormat_NoPageViews",
			expected:    nil,
			fieldName:   "session_utm_creative_format",
		...
		{
			name:        "SessionClickIDGclid_FirstEvent",
			expected:    "abc123",
			fieldName:   "session_click_id_gclid",
			description: "Valid session click ID gclid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "page_view"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?gclid=abc123"),
				columntests.EnsureEventName(1, "page_view"),
				columntests.EnsureQueryParam(1, "dl", "https://example.com/page?gclid=def456"),
			},
		},
		{
			name:        "SessionClickIDGclid_SecondEvent",
			expected:    "def456",
			fieldName:   "session_click_id_gclid",
			description: "Session click ID gclid is the first page view's gclid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?gclid=abc123"),
		...
		{
			name:        "SessionClickIDGclid_NoPageViews",
			expected:    nil,
			fieldName:   "session_click_id_gclid",
			description: "Session click ID gclid is nil when no page views",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?gclid=abc123"),
		...
		{
			name:        "SessionClickIDDclid_FirstEvent",
			expected:    "abc123",
			fieldName:   "session_click_id_dclid",
			description: "Valid session click ID dclid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "page_view"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?dclid=abc123"),
				columntests.EnsureEventName(1, "page_view"),
				columntests.EnsureQueryParam(1, "dl", "https://example.com/page?dclid=def456"),
			},
		},
		{
			name:        "SessionClickIDDclid_SecondEvent",
			expected:    "def456",
			fieldName:   "session_click_id_dclid",
			description: "Session click ID dclid is the first page view's dclid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?dclid=abc123"),
		...
		{
			name:        "SessionClickIDDclid_NoPageViews",
			expected:    nil,
			fieldName:   "session_click_id_dclid",
			description: "Session click ID dclid is nil when no page views",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?dclid=abc123"),
		...
		{
			name:        "SessionClickIDSrsltid_FirstEvent",
			expected:    "abc123",
			fieldName:   "session_click_id_srsltid",
			description: "Valid session click ID srsltid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "page_view"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?srsltid=abc123"),
				columntests.EnsureEventName(1, "page_view"),
				columntests.EnsureQueryParam(1, "dl", "https://example.com/page?srsltid=def456"),
			},
		},
		{
			name:        "SessionClickIDSrsltid_SecondEvent",
			expected:    "def456",
			fieldName:   "session_click_id_srsltid",
			description: "Session click ID srsltid is the first page view's srsltid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?srsltid=abc123"),
		...
		{
			name:        "SessionClickIDSrsltid_NoPageViews",
			expected:    nil,
			fieldName:   "session_click_id_srsltid",
			description: "Session click ID srsltid is nil when no page views",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?srsltid=abc123"),
		...
		{
			name:        "SessionClickIDGbraid_FirstEvent",
			expected:    "abc123",
			fieldName:   "session_click_id_gbraid",
			description: "Valid session click ID gbraid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "page_view"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?gbraid=abc123"),
				columntests.EnsureEventName(1, "page_view"),
				columntests.EnsureQueryParam(1, "dl", "https://example.com/page?gbraid=def456"),
			},
		},
		{
			name:        "SessionClickIDGbraid_SecondEvent",
			expected:    "def456",
			fieldName:   "session_click_id_gbraid",
			description: "Session click ID gbraid is the first page view's gbraid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?gbraid=abc123"),
		...
		{
			name:        "SessionClickIDGbraid_NoPageViews",
			expected:    nil,
			fieldName:   "session_click_id_gbraid",
			description: "Session click ID gbraid is nil when no page views",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?gbraid=abc123"),
		...
		{
			name:        "SessionClickIDWbraid_FirstEvent",
			expected:    "abc123",
			fieldName:   "session_click_id_wbraid",
			description: "Valid session click ID wbraid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "page_view"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?wbraid=abc123"),
				columntests.EnsureEventName(1, "page_view"),
				columntests.EnsureQueryParam(1, "dl", "https://example.com/page?wbraid=def456"),
			},
		},
		{
			name:        "SessionClickIDWbraid_SecondEvent",
			expected:    "def456",
			fieldName:   "session_click_id_wbraid",
			description: "Session click ID wbraid is the first page view's wbraid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?wbraid=abc123"),
		...
		{
			name:        "SessionClickIDWbraid_NoPageViews",
			expected:    nil,
			fieldName:   "session_click_id_wbraid",
			description: "Session click ID wbraid is nil when no page views",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?wbraid=abc123"),
		...
		{
			name:        "SessionClickIDFbclid_FirstEvent",
			expected:    "abc123",
			fieldName:   "session_click_id_fbclid",
			description: "Valid session click ID fbclid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "page_view"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?fbclid=abc123"),
				columntests.EnsureEventName(1, "page_view"),
				columntests.EnsureQueryParam(1, "dl", "https://example.com/page?fbclid=def456"),
			},
		},
		{
			name:        "SessionClickIDFbclid_SecondEvent",
			expected:    "def456",
			fieldName:   "session_click_id_fbclid",
			description: "Session click ID fbclid is the first page view's fbclid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?fbclid=abc123"),
		...
		{
			name:        "SessionClickIDFbclid_NoPageViews",
			expected:    nil,
			fieldName:   "session_click_id_fbclid",
			description: "Session click ID fbclid is nil when no page views",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?fbclid=abc123"),
		...
		{
			name:        "SessionClickIDMsclkid_FirstEvent",
			expected:    "abc123",
			fieldName:   "session_click_id_msclkid",
			description: "Valid session click ID msclkid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "page_view"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?msclkid=abc123"),
				columntests.EnsureEventName(1, "page_view"),
				columntests.EnsureQueryParam(1, "dl", "https://example.com/page?msclkid=def456"),
			},
		},
		{
			name:        "SessionClickIDMsclkid_SecondEvent",
			expected:    "def456",
			fieldName:   "session_click_id_msclkid",
			description: "Session click ID msclkid is the first page view's msclkid",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?msclkid=abc123"),
		...
		{
			name:        "SessionClickIDMsclkid_NoPageViews",
			expected:    nil,
			fieldName:   "session_click_id_msclkid",
			description: "Session click ID msclkid is nil when no page views",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
			caseConfigFuncs: []columntests.CaseConfigFunc{
				columntests.EnsureEventName(0, "scroll"),
				columntests.EnsureQueryParam(0, "dl", "https://example.com/page?msclkid=abc123"),
		...
		{
			name:        "SessionTotalPageViews_Zero",
			expected:    0,
			fieldName:   "session_total_page_views",
			description: "Session total page views",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
		...
		{
			name:        "SessionUniquePageViews_Different",
			expected:    2,
			fieldName:   "session_unique_page_views",
			description: "Session unique page views",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
		...
		{
			name:        "SessionTotalOutboundClicks",
			expected:    2,
		...
		{
			name:        "SessionTotalOutboundClicks_Zero",
			expected:    0,
			fieldName:   "session_total_outbound_clicks",
			description: "Session total outbound clicks",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
		...
		{
			name:        "SessionUniqueOutboundClicks_TheSameTwice",
			expected:    1,
		...
		{
			name:        "SessionUniqueOutboundClicks_Different",
			expected:    2,
			fieldName:   "session_unique_outbound_clicks",
			description: "Session unique outbound clicks",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
		...
		{
			name:        "SessionTotalFormInteractions",
			expected:    2,
		...
		{
			name:        "SessionTotalFormInteractions_Zero",
			expected:    0,
			fieldName:   "session_total_form_interactions",
			description: "Session total form interactions",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
		...
		{
			name:        "SessionUniqueFormInteractions",
			expected:    2,
		...
		{
			name:        "SessionTotalVideoEngagements",
			expected:    2,
		...
		{
			name:        "SessionTotalVideoEngagements_Zero",
			expected:    0,
			fieldName:   "session_total_video_engagements",
			description: "Session total video engagements",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
		...
		{
			name:        "SessionTotalVideoEngagements_Different",
			expected:    2,
			fieldName:   "session_total_video_engagements",
			description: "Session total video engagements",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
		...
		{
			name:        "SessionTotalFileDownloads",
			expected:    2,
		...
		{
			name:        "SessionTotalFileDownloads_Zero",
			expected:    0,
			fieldName:   "session_total_file_downloads",
			description: "Session total file downloads",
			hits:        columntests.TestHits{columntests.TestHitOne(), columntests.TestHitTwo()},
		...
		{
			name:        "SessionUniqueFileDownloads",
			expected:    1,
