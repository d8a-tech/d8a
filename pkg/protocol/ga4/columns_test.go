...
func TestEventColumns(t *testing.T) {
	...
	var eventColumnTestCases = []struct {
		...
		{
			name:        "EventDocumentLocation_Valid",
			param:       "dl",
			value:       "https://example.com/page",
			expected:    "https://example.com/page",
			fieldName:   "document_location",
			description: "Valid document location",
		},
		{
			name:        "EventDocumentLocation_Empty",
			param:       "dl",
			value:       "",
			expected:    "",
			fieldName:   "document_location",
			description: "Empty document location",
		},
		{
			name:        "EventDocumentReferrer_Valid",
			param:       "dr",
			value:       "https://google.com",
			expected:    "https://google.com",
			fieldName:   "document_referrer",
			description: "Valid document referrer",
		},
		{
			name:        "EventDocumentReferrer_Empty",
			param:       "dr",
			value:       "",
			expected:    "",
			fieldName:   "document_referrer",
