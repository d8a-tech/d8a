		...
		[]testCase{
			{
				...
				expected:    "42",
				description: "Valid measurement ID via idsite query parameter",
			},
			{
				...
				fieldName:   "measurement_id",
				expected:    nil,
				description: "Returns nil when idsite parameter is empty",
			},
			{
				...
				fieldName:   "measurement_id",
				expected:    nil,
				description: "Returns nil when idsite parameter is absent",
			},
			{
