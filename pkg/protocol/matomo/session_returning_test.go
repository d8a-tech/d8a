	...
	testCases := []testCase{
		{
			...
			expected:    false,
			description: "_idn=1 on the first event means new user and session_returning_user=false",
		},
		{
			...
			expected:    true,
			description: "_idn=0 on the first event means returning user and session_returning_user=true",
		},
		{
			...
			cfg:         nil,
			expected:    false,
			description: "missing _idn defaults to session_returning_user=false",
		},
		{
