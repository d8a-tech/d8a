...
describe("GA4 Duplicator Blackbox Tests", () => {
  ...
  describe("Fetch Interception", () => {
    ...
    it("should use the provided server_container_url as the full endpoint URL", async () => {
      // given
      const ORIGIN = "https://my-server.com/my/custom/path";
      initDuplicator({ server_container_url: ORIGIN });
