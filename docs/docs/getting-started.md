...
- Review the [columns documentation](./columns.md) to understand the data schema
- Explore the [protocols documentation](./protocols/ga4.md) for detailed protocol information
