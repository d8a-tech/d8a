...
Follow the [Intercepting GA4 Events](/docs/intercepting-ga4-events) guide to configure your Google Tag Manager implementation to send data to your d8a endpoint.
