...
The below code is available for audit in the "Non-minified (for auditing)" tab or in the [source code](https://github.com/d8a-tech/d8a/tree/master/js/duplicator).
